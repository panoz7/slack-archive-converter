...
class SlackChannel {
    ...
    mapEntry(message) {
        try {
            ...
            let isPoll = false; 
            if (message.bot_profile && message.bot_profile.name == 'Simple Poll') {
                isPoll = true;
            }

            const text = isPoll ? this.formatPollText(message) : message.text;
        ...
        return new Promise((resolve, reject) => {
            ...
            https.get(url, response => {
                ...
                response.on('end', () => {
                    ...
                    console.log('')
                    console.log(`${currentCount} / ${total}`)
